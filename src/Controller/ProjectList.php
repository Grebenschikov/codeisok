...
class ProjectList extends Base
{
    ...
    protected function LoadData()
    {
        ...
        $this->tpl->assign('allow_create_projects', \CodeIsOk\Config::GetInstance()->GetValue(\CodeIsOk\Config::ALLOW_USER_CREATE_REPOS, false));

        $projectList = \CodeIsOk\Git\ProjectList::GetInstance();
