...
class Commit extends \CodeIsOk\Git\GitObject
{
    /**
     * dataRead
     *
     ...
     *
     * @access public
     * @return \CodeIsOk\Git\Commit commit object for parent
     */
     ...
     *
     * @access public
     * @return\CodeIsOk\Git\Tag[] array of tags
     */
     ...
     *
     * @access public
     * @return \CodeIsOk\Git\Tag? tag object
     */
     ...
     *
     * @access public
     * @return \CodeIsOk\Git\TreeDiff Tree diff
     */
    public function DiffToParent()
    {
        return new \CodeIsOk\Git\TreeDiff($this->GetProject(), $this->hash, '', new \CodeIsOk\DiffContext());
    }
