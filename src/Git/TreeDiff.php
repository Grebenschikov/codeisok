...
class TreeDiff implements \Iterator
{
    ...
    /**
     * @param \CodeIsOk\Git\Project $project project
     ...
     */
    public function __construct($project, $toHash, $fromHash = '', \CodeIsOk\DiffContext $DiffContext = null)
    {
        ...
        if (empty($toCommit)) {
            throw new \CodeIsOk\MessageException('Commit not found ' . $toHash);
        }
        $this->toHash = $toHash;
