...
class Archive
{
    ...
    public function SetObject($object)
    {
        ...
        if (($object != null) && (!(($object instanceof \CodeIsOk\Git\Commit) || ($object instanceof \CodeIsOk\Git\Tree)))) {
    ...
    {
        return \CodeIsOk\Git\Archive::FormatToExtension($this->format);
    }
    ...
    public function GetData()
    {
        ...
        $exe = new \CodeIsOk\Git\GitExe($this->GetProject());
        ...
        switch ($this->format) {
            case self::GITPHP_COMPRESS_BZ2:
                $data = bzcompress($data, \CodeIsOk\Config::GetInstance()->GetValue('compresslevel', 4));
                break;

            case self::GITPHP_COMPRESS_GZ:
                $data = gzencode($data, \CodeIsOk\Config::GetInstance()->GetValue('compresslevel', -1));
                break;
        }
    ...
    {
        $formats = array();
        $formats[self::GITPHP_COMPRESS_TAR] = \CodeIsOk\Git\Archive::FormatToExtension(self::GITPHP_COMPRESS_TAR);
        $formats[self::GITPHP_COMPRESS_ZIP] = \CodeIsOk\Git\Archive::FormatToExtension(self::GITPHP_COMPRESS_ZIP);

        if (function_exists('bzcompress')) {
            $formats[self::GITPHP_COMPRESS_BZ2] = \CodeIsOk\Git\Archive::FormatToExtension(self::GITPHP_COMPRESS_BZ2);
        }
        if (function_exists('gzencode')) {
            $formats[self::GITPHP_COMPRESS_GZ] = \CodeIsOk\Git\Archive::FormatToExtension(self::GITPHP_COMPRESS_GZ);
        }
