...
class ProjectCreate extends Base
{
    ...
    protected function getModel()
    {
        if (!isset($this->ModelGitosis)) {
            $this->ModelGitosis = new \CodeIsOk\Model\Gitosis();
        }
    ...
    protected function ReadQuery()
    {
        if (count($_POST)) {
            ...
            if (empty($this->form_errors)) {
                ...
                //creating the repo
                if (\CodeIsOk\Config::GetInstance()->GetValue(\CodeIsOk\Config::UPDATE_AUTH_KEYS_FROM_WEB)) {
                    $base_path = \CodeIsOk\Config::GetInstance()->GetValue(\CodeIsOk\Config::PROJECT_ROOT);
