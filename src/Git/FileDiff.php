...
class FileDiff
{
     ...
     * @param \CodeIsOk\DiffContext $DiffContext
     * @param string $branch
     * @throws \Exception
     */
    public function __construct(\CodeIsOk\Git\Project $project, $fromHash, $toHash = '', \CodeIsOk\DiffContext $DiffContext, $branch = '')
    {
     ...
     *
     * @access public
     * @return \CodeIsOk\Git\Blob blob object
     */
    ...
    public function GetFromFileType($local = false)
    {
        ...
        return \CodeIsOk\Git\Blob::FileType($this->fromMode, $local);
    }
    ...
    public function GetToFileType($local = false)
    {
        ...
        return \CodeIsOk\Git\Blob::FileType($this->toMode, $local);
    }
    ...
    public function GetDiff($file = '', $readFileData = true, $explode = false, $highlight_changes = true)
    {
        ...
        if (\CodeIsOk\Util::checkFileIsImage($this->fromFile) || \CodeIsOk\Util::checkFileIsImage($this->toFile)) {
            $this->diffData = \CodeIsOk\Util::getImagesDiff($fromBlob, $toBlob, $this->GetFromFile(), $this->GetToFile());
        ...
        if ($highlight_changes && mb_strlen($this->diffData) <= $this->GetLargeDiffSize()) {
            $this->inline_changes = \CodeIsOk\DiffHighlighter::getMarks($this->diffData);
        }
    ...
    public function GetDiffSplit()
    {
        ...
        $exe = new \CodeIsOk\Git\GitExe($this->project);
     ...
     *
     * @access public
     * @return \CodeIsOk\Git\Commit object
     */
     ...
     */
    public function diffWithFormattedBase(\CodeIsOk\Git\TmpDir $tmpdir, $fromTmpFile, $toTmpFile, $fromName, $toName)
    {
