...
class Jira
{
    ...
    public static function instance()
    {
        if (!self::$instance) {
            ...
            self::$instance->url = \CodeIsOk\Config::GetInstance()->GetJiraUrl();
            self::$instance->crowd_url = \CodeIsOk\Config::GetInstance()->GetCrowdUrl();
            self::$instance->crowd_token = \CodeIsOk\Config::GetInstance()->GetCrowdToken();
        }
    ...
    public static function getCookieName()
    {
        ...
        if (\CodeIsOk\Config::GetInstance()->GetAuthMethod() == \CodeIsOk\Config::AUTH_METHOD_JIRA) {
    ...
    public function crowdAuthenticatePrincipalByCookie($crowd_token_key)
    {
        ...
        if ($domain = \CodeIsOk\Config::GetInstance()->GetValue(\CodeIsOk\Config::CROWD_SSO_DOMAIN)) {
    ...
    protected function request($url, $http_method, $method, $data = null, $headers = [])
    {
        ...
        $Response = new HttpResponse(isset($http_response_header) ? $http_response_header : [], $body);
