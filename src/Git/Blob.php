...
class Blob extends \CodeIsOk\Git\FilesystemObject
{
    /**
     * data
     *
    ...
    {
        $exe = new \CodeIsOk\Git\GitExe($Project);
    ...
    private function ReadHistory()
    {
        ...
        foreach ($historylines as $line) {
            if (preg_match('/^([0-9a-fA-F]{40})/', $line, $regs)) {
                ...
                try {
                    $history = new \CodeIsOk\Git\FileDiff($this->GetProject(), $line, '', new \CodeIsOk\DiffContext());
