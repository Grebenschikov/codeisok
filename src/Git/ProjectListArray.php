 ...
 * @subpackage Git
 */
class ProjectListArray extends \CodeIsOk\Git\ProjectListBase
{
    /**
     * __construct
     *
            ...
            try {
                if (is_string($projData)) {
                    ...
                    if (is_string($proj) && !empty($proj)) {
                        ...
                        $projObj = new \CodeIsOk\Git\Project($projData['project']);
