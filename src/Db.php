...
class Db
{
    ...
    public function __construct()
    {
        ...
        if (!$this->link) {
            \CodeIsOk\Log::GetInstance()->Log('mysqli_connect', "$user@$host");
        }
    }
    ...
    public function query($sql, $params)
    {
        ...
        \CodeIsOk\Log::GetInstance()->timerStop('mysqli_query', $sql);
        ...
        if (!$result) {
            ...
            trigger_error($msg);
            \CodeIsOk\Log::GetInstance()->Log('mysqli_error', "$this->errno: $this->error");
        } else {
