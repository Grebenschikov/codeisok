...
abstract class GitObject
{
     ...
     *
     * @access public
     * @return \CodeIsOk\Git\Project
     */
    public function GetProject()
    {
        if ($this->projectReferenced) $this->DereferenceProject();
    ...
    private function DereferenceProject()
    {
        ...
        $this->project = \CodeIsOk\Git\ProjectList::GetInstance()->GetProject($this->project);
    ...
    {
        if (!$this->projectReferenced) $this->ReferenceProject();
    ...
    {
        $projKey = 'project|';
        if ($this->projectReferenced) $projKey .= $this->project;
        else $projKey .= $this->project->GetProject();
